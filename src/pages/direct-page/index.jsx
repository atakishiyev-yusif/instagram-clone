import { DirectSidebar } from "~/components/direct-sidebar";
...
export const DirectPage = () => {
  return (
    <div className="flex justify-between">
      <DirectSidebar />
      <div className="flex items-center justify-center flex-col gap-6 translate-x-[100%]">
        <div>
          <svg
            aria-label=""
        ...
        <div className="items-center text-center flex flex-col gap-4">
          ...
          <p className="text-[#9A9B9C] text-sm">
            Send private photos and messages to a friend or group
          </p>
          <button className="bg-[#058BE2] text-white w-[118px] h-[32px] px-4 text-xs font-semibold rounded-lg hover:opacity-70  transition-colors">
            Send message
          </button>
        </div>
      </div>
